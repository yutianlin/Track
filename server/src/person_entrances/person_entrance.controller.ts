import PersonDateEntranceService from "./person_entrance.service";
import { createRelationSchema } from "./person_entrance.schema";
...
module.exports = function (app: any) {
  app.get("/person_entrances", async (request: any, response: any) =>
