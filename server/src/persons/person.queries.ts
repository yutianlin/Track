...
export const GetPersonsPossiblyInfected = (personId: number, startDay: string, endDay: string) => {
  ...
  const getRoomsUsed = UnionQueries(getRoomsOfClassesUsed, getRoomsOfEntrancesUsed);
